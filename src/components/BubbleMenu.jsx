  ...
  return (
    <>
      <nav className={containerClassName} style={style} aria-label="Main navigation">
        <Link to="/" className="bubble logo-bubble" aria-label="Logo" style={{ background: 'transparent', boxShadow: 'none' }}>
        ...
        <div className="nav-right" style={{ display: 'flex', gap: '1rem' }}>
          <ThemeToggle bgColor={menuBg} contentColor={menuContentColor} />
