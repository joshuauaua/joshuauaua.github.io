        ...
        <div className="about-content">
          ...
          <div>
            <p className="about-text">
              ...
              tools. Today, I’m diving deep into .NET Core, MVC, React, Git, and
              more, while also staying tuned to broader shifts in AI and
              emerging technologies. We’re living in a moment where technology
